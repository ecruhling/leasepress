...
(function ($) {
  ...
  $(function () {// Write in console log the PHP value passed in enqueue_js_vars in public/class-plugin-name.php
  ...
  $(document).ready(function () {
    ...
    new (svg_injector__WEBPACK_IMPORTED_MODULE_0___default())(injectedSVGs, injectorOptions, function () {
      // Variables
