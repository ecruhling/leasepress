...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var svg_injector__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svg-injector */ "./node_modules/svg-injector/svg-injector.js");
...
$(document).ready(function () {
  ...
  new svg_injector__WEBPACK_IMPORTED_MODULE_0___default.a(injectedSVGs, injectorOptions, function () {
    // Variables
    var $units = $('.injected-svg g[id^="units"] [id^="unit"]'); // all individual units
    ...
    $('.unit-data').each(function () {
      var number = $(this).data('number'); // unit-xxx
    ...
    $units.hover(function () {
      ...
      var main = $('#site-plans-content');
      var offset = $(this).offset();
      var offsetLeft = offset.left - main.offset().left;
      var offsetTop = offset.top - main.offset().top;
      var position = {
        left: offsetLeft + 50,
        top: offsetTop
      };
