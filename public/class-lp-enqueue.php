...
class LP_Enqueue extends LP_Base {
	...
	public static function enqueue_styles() {
		wp_enqueue_style( 'leasepress-plugin-styles', plugins_url( 'dist/styles/public.css', LP_PLUGIN_ABSOLUTE_PATH ), array(), LP_VERSION );
	}
	...
	public static function enqueue_scripts() {
		...
		if ( is_page_template( $template ) ) {
			wp_enqueue_script( 'leasepress-plugin-script', plugins_url( 'dist/scripts/public.js', LP_PLUGIN_ABSOLUTE_PATH ), array( 'jquery' ), LP_VERSION, true );
		}
	}
