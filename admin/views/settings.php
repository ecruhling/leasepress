	...
	<div class="inside">
		...
		<form method="post">
			...
			<p class="create-floor-plans">
				...
				<?php submit_button( esc_html__( 'Create Floor Plans' ), 'secondary lp_create_floor_plans', 'lp_create_floor_plans_submit', false ); ?>
				<svg id="create-floor-plans-loader" class="loader" width="60px" height="60px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 0 0" xml:space="preserve">
				<path fill="#007cba" d="M73,50c0-12.7-10.3-23-23-23S27,37.3,27,50 M30.9,50c0-10.5,8.5-19.1,19.1-19.1S69.1,39.5,69.1,50">
					<animateTransform
						attributeName="transform"
						attributeType="XML"
	...
	<div class="inside">
		...
		<form method="post">
			...
			<p class="delete-floor-plans">
				...
				<?php submit_button( esc_html__( 'Delete Floor Plans' ), 'secondary lp_delete_floor_plans', 'lp_delete_floor_plans_submit', false ); ?>
				<svg id="delete-floor-plans-loader" class="loader" width="60px" height="60px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 0 0" xml:space="preserve">
				<path fill="#007cba" d="M73,50c0-12.7-10.3-23-23-23S27,37.3,27,50 M30.9,50c0-10.5,8.5-19.1,19.1-19.1S69.1,39.5,69.1,50">
					<animateTransform
						attributeName="transform"
						attributeType="XML"
